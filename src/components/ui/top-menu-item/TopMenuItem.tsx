...
export const TopMenuItem:FC <Props> = ({categoryName,subcategories,image}) => {
...
<li className=' group px-3 py-2 '>
    ...
    <div
    className='
    absolute top-5 left-0 transition
    ...
    >
      <div
      className='relative   bg-white rounded-xl shadow-xl  left-0 top-0  flex justify-start items-center pl-8'
      >
        ...
        <div className='z-10'>
          <div className='flex  h-[400px]  '>
            <div className='mt-8 '>
             ...
             {image!=='' &&  (<Image
                src={`/products/${image}`} alt="product image" 
                width={600}
                height={600}
